...
const Tech = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="flex flex-col justify-center items-center group/tech"><svg contenteditable="true" class="fill-current text-text-color h-20 transition-colors duration-300 w-12 sm:w-16 md:w-20 svelte-j6jovu" style="${"--color:" + escape(color, true) + ";"}">${(($$value) => $$value === void 0 ? `` : $$value)(icon)}</svg>
    <p class="text-text-color text-center my-1 md:mt-2 -translate-y-full opacity-0 group-hover/tech:opacity-100 group-hover/tech:translate-y-0 transition-all duration-300 text-xs sm:text-sm md:text-base">${escape(name)}</p>
</div>`;
});
const css$1 = {
  code: "@keyframes from-left{0%{transform:rotateX(50deg) translateX(-100vw) skewX(-50deg);opacity:0}100%{transform:rotateX(0deg) translateX(0) skewX(0deg);opacity:1}}@keyframes from-right{0%{transform:rotateX(-50deg) translateX(100vw) skewX(50deg);opacity:0}100%{transform:rotateX(0deg) translateX(0) skewX(0deg);opacity:1}}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<div><h1 class="text-5xl md:text-6xl lg:text-8xl text-secondary-color opacity-100 mb-16 animate-dropin">Tech I use</h1>
    ...
    {
      default: () => {
        return `<div class="bg-primary-accent-color p-8 rounded mb-8"><h2 class="text-3xl md:text-4xl lg:text-5xl text-text-color">For client-side applications</h2>
            <div class="grid grid-flow-col grid-rows-2 md:grid-rows-1 justify-between mt-6">${validate_component(Tech, "Tech").$$render($$result, { name: "CSS", icon: css$2, color: "#2495EF" }, {}, {})}
                ${validate_component(Tech, "Tech").$$render(
          $$result,
          {
            name: "HTML",
            icon: html,
    ...
    {
      default: () => {
        return `<div class="bg-primary-accent-color p-8 rounded mb-8"><h2 class="text-3xl mg:text-4xl lg:text-5xl text-text-color">For backend applications</h2>
            <div class="grid grid-flow-col grid-rows-2 md:grid-rows-1 justify-between mt-6">${validate_component(Tech, "Tech").$$render(
          $$result,
          {
            name: "Java",
            icon: java,
          ...
          {}
                ...
                ${validate_component(Tech, "Tech").$$render($$result, { name: "PHP", icon: php, color: "#8993BE" }, {}, {})}
                ${validate_component(Tech, "Tech").$$render(
          $$result,
          {
            name: "MySQL",
    ...
    {
      default: () => {
        return `<div class="bg-primary-accent-color p-8 rounded mb-8"><h2 class="text-3xl md:text-4xl lg:text-5xl text-text-color">The tools I use</h2>
            <div class="grid grid-flow-col grid-rows-2 md:grid-rows-1 justify-between mt-6">${validate_component(Tech, "Tech").$$render(
          $$result,
          {
            name: "GitHub",
